				...
				{authUser.role === "Student" && (
					<SidebarMenu className="mb-3">
						<NavLink
							...
							className="bg-primary-950 dark:bg-primary-800 rounded-2xl transition-all active:scale-95 flex items-center px-6 gap-2 text-white dark:text-primary-foreground py-2 hover:bg-primary-900 dark:hover:bg-primary-700 shadow-sm hover:shadow-md">
